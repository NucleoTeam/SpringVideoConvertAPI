...
public class VideoController {
    ...
    public Video videoUpload(@RequestParam("file") MultipartFile file,
        ...
        Process pr = rt.exec("ffmpeg -ss 00:02:00.435 -i " +VideoConverter.sourceDirectory+v.getOriginal()+ " -vframes 1 -vf scale=300:168 "+VideoConverter.sourceDirectory+v.getOriginal() + ".png");
        pr.waitFor();
